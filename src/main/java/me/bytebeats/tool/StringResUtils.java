...
public class StringResUtils {
    ...
    public static final String STOCK_VOLUME = "成交量(手)";
    public static final String TURNOVER = "成交额(万)";
    ...
    public static final String INDEX_OPEN = "今开";
    public static final String INDEX_CLOSE = "昨收";
